...
the top right of this page. Once
complete, clone the repository to your computer by running the following
commands:

```
cd 5-friday (or make a new project folder and cd into that, up to you!)
git clone https://github.com/<your-username-here>/Project-2-Feedr.git
cd Project-2-Feedr
```

You can then open VS Code and work on the below steps. As you accomplish a feature, be sure to commit it in
